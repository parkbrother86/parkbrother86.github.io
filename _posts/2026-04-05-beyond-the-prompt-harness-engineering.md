...
categories:
  - utility-pipeline
excerpt: "On a solo game server project, I learned that using AI well depends less on clever prompts and more on building task-specific skills, workflows, and guardrails."
